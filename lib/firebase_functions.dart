...
class FireBaseFunctions {
  ...
  static CollectionReference<TaskModel> getTasksCollection(String userID) => getUserCollection().doc(userID).collection('tasks').withConverter<TaskModel>(
            fromFirestore: (docSnapshot, _) =>
  ...
  static Future <void> editTask (String userId ,TaskModel task,String taskid ,String t ,String d,DateTime dt) async
  {
    CollectionReference<TaskModel> taskCollection = getTasksCollection(userId);
    DocumentReference<TaskModel> doc = taskCollection.doc();
    task.title =t;
